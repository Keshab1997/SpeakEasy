...
**Personal skills live in the configured DotCraft skills directory.**
...
**Guidance:** Use this document for TDD-focused skill authoring patterns and examples.
...
**The trap:** Descriptions that summarize workflow create a shortcut agents may take. The skill body becomes documentation agents skip.
...
**IMPORTANT: Use task tracking tool to create todos for EACH checklist item below.**
