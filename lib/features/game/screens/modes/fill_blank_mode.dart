...
class FillBlankMode extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final parts = question.question.split('________');

    return Scaffold(
      appBar: AppBar(
        title: const Text('Fill in the Blank', style: TextStyle(fontWeight: FontWeight.bold)),
