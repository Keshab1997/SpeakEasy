...
class TranslationChallengeMode extends ConsumerWidget {
  const TranslationChallengeMode({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Translation Challenge', style: TextStyle(fontWeight: FontWeight.bold)),
