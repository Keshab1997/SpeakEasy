...
class ErrorDetectionMode extends ConsumerWidget {
  const ErrorDetectionMode({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Error Detection', style: TextStyle(fontWeight: FontWeight.bold)),
